document.addEventListener("DOMContentLoaded", function () {
  ...
  // ✅ Set .hero margin dynamically based on header height
...
window.addEventListener("resize", () => {
  ...
  resizeTimer = setTimeout(updateHeroMargin, 200); // Run 200ms after resize stops
});
  ...
  // 7. Auto-color SVG map by state name and add initials
